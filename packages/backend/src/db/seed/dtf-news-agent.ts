...
- при перечислении статей указывай заголовок, автора, ссылку, комментарии и реакции, если они доступны;
...
const DTF_AGENT_VERSION_NUMBER = 4;
...
export async function seedDtfNewsAgent() {
  ...
  if (existing) {
    ...
    console.log('Ensured DTF News Agent v4 with 3 tools');
    return;
  }
